...
from search_space import init_search_space
from search_alg.regularized_ea import RegularizedEASampler, SampleController
from search_alg.evaluator import ModelAcquireData, FilterEvaluator
...
if __name__ == "__main__":
    from global_args import parse_arguments
