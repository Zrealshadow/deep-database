...
# %%
tk_db = tokenize_database(db, col_type_dict, './ram/tmp_docs/rel-stack', True)
...
#     retriever.save(f"./ram/tmp/stack/{entity}_retriever_bm25")
...
entity_to_retriver = {}
for entity in entity_tables:
    path = f"./ram/tmp/stack/{entity}_retriever_bm25"
...
path = f"./ram/edges/rel-stack-edges.npz"
