...
# %%
db = DatabaseFactory.get_db("trial", with_text_compress=False)
...
# %%
tk_db = tokenize_database(db, col_type_dict, './ram/tmp_docs/rel-trails', True)
...
#     retriever.save(f"./ram/tmp/rel-trial/{entity}_retriever_bm25")
...
entity_to_retriver = {}
for entity in entity_tables:
    path = f"./ram/tmp/rel-trial/{entity}_retriever_bm25"
...
path = f"./ram/edges/rel-trial-edges-thresh-mean-3std.npz"
...
# %%
# different threshold to get high-confidence positive pairs
...
path = "./samples/rel-trail-samples-thresh09.npz"
