# Script to generate all table selection prompts 
# and save them in static/table_selection directory
# Usage: ./generate_table_selection_prompt.sh

set -e  # Exit on any error

# Configuration
OUTPUT_DIR="aida/static/table_selection"
...
Usage:
------
Each file contains a complete table selection 
prompt for the specified database and task.
