#!/bin/bash
# Generate fit-best fit table data
export PYTHONPATH=$(pwd)
set -e  # Exit on error

OUTPUT_DIR="./data/fit-best-table"
SAMPLE_SIZE=100000
MAX_DEPTH=2
N_TIMEDELTA=4

echo "Running Avito tasks (best-fit)..."
...
echo "Running RateBeer tasks (best-fit)..."
...
echo "Running Trial tasks (best-fit)..."
...
echo "Running Event tasks (best-fit)..."
...
echo "Running HM tasks (best-fit)..."
...
echo "All best-fit tasks completed!"
